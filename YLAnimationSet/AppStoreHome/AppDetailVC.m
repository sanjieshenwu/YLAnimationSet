...
@interface AppDetailVC ()<UITableViewDelegate,UITableViewDataSource,UIViewControllerAnimatedTransitioning,UINavigationControllerDelegate,UIGestureRecognizerDelegate>
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    AppStoreHomeVC *toVC = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    AppDetailVC *fromVC = [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
...
- (UILabel *)contentLabel {
    if (_contentLabel == nil) {
        ...
        _contentLabel.textColor = UIColorFromRGB(0x7f7f82);
